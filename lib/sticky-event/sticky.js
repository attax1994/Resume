...
(function () {
  ...
  function fire(stuck, target) {
    var isUpside = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : true;
    ...
    if (stuck) {
      allTocsItems.map(function (el) {
        var isMatch = el.firstElementChild.getAttribute('href').slice(1) === target.firstElementChild.id;
